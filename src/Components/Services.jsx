...
const Section = styled.section`
    ...
    .services {
        ...
        margin-top: 10rem;
        gap: 5rem;
        &__service { /* since the first word in the class is service then you can add & for similar classes and the words that follow them for example 'service' in this line*/
           padding: 2rem;
           &:nth-of-type(2) {
