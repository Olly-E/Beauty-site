...
const Pricing = () => {
    ...
    const data = [
      ...
      {
        value: "Lower Lip N5000",
        type: "Basic",
      },
      {
        value: "Upper Lip N5000",
        type: "Basic",
      },
      {
        value: "Under arms N1000",
        type: "Basic",
      },
      {
        value: "Full Legs N4500",
        type: "Pro",
      },
      {
        value: "Half Legs N3000",
        type: "Pro",
      },
      {
        value: "Daily Backups",
  ...
  return (
    <Section ref={element}>
      ...
      <div className="background">
          ...
          <img src={pricing2} alt= "backgound" className='bg2' />
      </div>
              ...
              return(
                  ...
                  >
                      ...
                      <div className="pricing__plan__content">
                          <ul className={`pricing__plan__content__feautures ${name}`}>
